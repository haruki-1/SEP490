    ...
    namespace WebAPI.Utils.Middlewares
    {
        ...
        private readonly IConfiguration _configuration;
            private readonly string[] allowAnonymousAPI = { "Auth", "Product", "Comment", "Variant", "images","Blog" };
        ...
        public JWTAuthenticationMiddleware(IConfiguration configuration)
        {
            ...
            public async Task InvokeAsync(HttpContext context, RequestDelegate next)
            {
                ...
                || allowAnonymousAPI.Any(path => context.Request.Path.StartsWithSegments($"/api/v1/guest/{path}", StringComparison.OrdinalIgnoreCase))
